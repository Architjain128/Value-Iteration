...
iteration = 0
f = open("./outputs/part_2_task_2.2_trace.txt", "a")
while error>delta:
	error = -100000000
								...
								for i in allowed_moves[a]:
									if d == 'D':
										if i == 'A':
											...
											if i == a:
												ab = MM_dd*suc_prob[0]*(gamma*utility[possible_states.index(i)][w][x][y][z]) + MM_dr*suc_prob[0]*(gamma*utility[possible_states.index(i)][w][x][1][z]) + MM_dd*suc_prob[1]*(gamma*utility[possible_states.index('E')][w][x][y][z]) + MM_dr*suc_prob[1]*(gamma*utility[possible_states.index('E')][w][x][1][z])
											else:
										...
										if i == 'A':
											...
											for ii in prob_move[a]:
												suc_prob.append(float(ii)/100)
											if i == a:
												ab = MM_rr*suc_prob[0]*(gamma*utility[possible_states.index(i)][w][x][y][z]) + MM_rr*suc_prob[1]*(gamma*utility[possible_states.index('E')][w][x][1][z]) + MM_rd*(hit_reward) + MM_rd*gamma*(utility[v][w][0][0][health.index(min(e+25,100))])
											else:
									...
									if d == 'D':
										...
										if i == 'C':
											...
											for ii in prob_move[a]:
												...
												aa = suc_prob[0]
											if i == a:
												ab = MM_rr*suc_prob[0]*(gamma*utility[possible_states.index(i)][w][x][y][z]) + MM_rr*suc_prob[1]*(gamma*utility[possible_states.index('E')][w][x][1][z]) + MM_rd*suc_prob[0]*(gamma*utility[possible_states.index(i)][w][x][0][z]) + MM_rd*suc_prob[1]*(gamma*utility[possible_states.index('E')][w][x][0][z]) 
											else:
